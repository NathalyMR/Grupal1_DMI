...
public class RegisterScreen {
	private PApplet app;
	private boolean showName = true, showLastname = true, showEmail = true, showPassword = true, showNationality = true,
			showCellphone = true;
	...
	public void paintTextfields(PFont font) {
		...
		for (int i = 0; i < registerInputs.length; i++) {
			...
			cp5.addTextfield(registerInputs[i]).setPosition(30, 180 + (i * 60)).setSize(300, 30).setAutoClear(true)
	...
	public void paintScreen(PImage image, PFont font) {
		...
		if (showName == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 180
					&& app.mouseY < 215) {
				showName = false;
			}
		}
		if (showLastname == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 240
					&& app.mouseY < 275) {
				showLastname = false;
			}
		}
		if (showEmail == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 300
					&& app.mouseY < 335) {
				showEmail = false;
			}
		}
		if (showPassword == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 360
					&& app.mouseY < 395) {
				showPassword = false;
			}
		}
		if (showNationality == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 420
					&& app.mouseY < 455) {
		...
		if (showCellphone == true) {
			...
			if (app.mousePressed == true && app.mouseX > 30 && app.mouseX < 300 && app.mouseY > 480
					&& app.mouseY < 515) {
				showCellphone = false;
			}
		}
